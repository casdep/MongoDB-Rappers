...
var Album  = require('../model/rockalbum.model');
...
routes.post('/albums', function(req, res) {
  ...
  // var name = req.body.RockBand.name;
  // var artists = req.body.RockBand.artist;
  // var bestTack = req.body.RockBand.bestTack;

  var labelName = req.body.labelName;
  var labelAbbrevation = req.body.labelAbbrevation;
